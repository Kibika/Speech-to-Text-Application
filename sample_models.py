...
def simple_rnn_model(input_dim, output_dim=48):
...
def rnn_model(input_dim, units, activation, output_dim=48):
    """ Build a recurrent network for speech 
    """
    # Main acoustic input
    input_data = Input(name='the_input', shape=(None, input_dim))
...
def cnn_rnn_model(input_dim, filters, kernel_size, conv_stride,
    conv_border_mode, units, output_dim=48):
...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=48):
...
def bidirectional_rnn_model(input_dim, units, output_dim=48):
...
def final_model(input_dim, units, output_dim=48):
    ...
    bidir_rnn1 = Bidirectional(LSTM(units, return_sequences=True, dropout=0.5, recurrent_dropout=0.5,
